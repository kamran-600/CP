...
public class AttendanceClassAdapter extends RecyclerView.Adapter<AttendanceClassAdapter.ViewHolde> {
    ...
    @NonNull
    @Override
    public AttendanceClassAdapter.ViewHolde onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.fee_single_row, parent, false);
        return new AttendanceClassAdapter.ViewHolde(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AttendanceClassAdapter.ViewHolde holder, int position) {
